...
setup( name = 'DoDoc',
       ...
       py_modules = (r'DoDoc/__init__', 'DoDoc/DoDoc', 'DoDoc/DoDoc_parameters_parser', 'DoDoc/import_uno', 'DoDoc/odg2png', 'DoDoc/odt2pdf', 'DoDoc/OpenOffice_document', 'DoDoc/Template', 'DoDoc/DoXML', 'DoDoc/DoDoc_folder_printer', 'DoDoc/ods_parser'),
     )
